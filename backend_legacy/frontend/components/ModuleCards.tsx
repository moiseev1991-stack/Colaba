...
export function ModuleCards({ activeModule = 'seo', onModuleClick }: ModuleCardsProps) {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div
        className={cn(
          'bg-white dark:bg-gray-800 rounded-[14px] border-2 p-6 cursor-pointer transition-all',
          activeModule === 'seo'
      ...
      <div
        className={cn(
          'bg-white dark:bg-gray-800 rounded-[14px] border border-gray-200 dark:border-gray-700 p-6 cursor-not-allowed opacity-50'
        )}
      >
