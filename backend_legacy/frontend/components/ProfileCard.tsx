...
export function ProfileCard() {
  ...
  if (!user) {
    return (
      <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-[14px]">
  ...
  return (
    <div className="p-6 bg-white dark:bg-gray-800 rounded-[14px] border border-gray-200 dark:border-gray-700 shadow-sm w-full max-w-2xl">
