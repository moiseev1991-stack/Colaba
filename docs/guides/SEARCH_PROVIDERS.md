...
### 3. SerpAPI (deprecated) ❌ Устарел

**Статус:** Устарел, не рекомендуется к использованию. Используйте DuckDuckGo или Яндекс XML.
...
- Используйте **DuckDuckGo** - работает сразу, бесплатно, без настройки

### Для production (если нужны результаты Яндекса)
- Используйте **Яндекс XML API** - официальный API с результатами Яндекса
- Получите ключи на https://yandex.ru/dev/xml/
- Настройте rate limiting для production

### Для production (если результаты Яндекса не критичны)
- Используйте **DuckDuckGo** - бесплатно, без лимитов, работает стабильно
