...
- Разделы: пользователи, организации, поиски, результаты поиска, чёрный список доменов, соц. аккаунты, конфиги провайдеров поиска, AI-ассистенты, настройки капчи, деплои.
- Язык по умолчанию — русский; переключение на английский: `/admin/set-language/en`.
- Подробнее: [docs/guides/ADMIN_PANEL.md](docs/guides/ADMIN_PANEL.md).
