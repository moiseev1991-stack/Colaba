        ...
        "settings_schema": [
            {
                ...
                "required": False,
                "secret": False,
                "description": "Включить прокси для запросов",
            },
            {
                "key": "proxy_url",
                "label": "Прокси (один)",
                ...
                "required": False,
                "secret": False,
                "description": "http://host:port или socks5://host:port",
            },
            {
                "key": "proxy_list",
                "label": "Список прокси",
                ...
                "required": False,
                "secret": False,
                "description": "Через запятую для ротации",
            },
            {
                "key": "use_mobile",
                "label": "Мобильный URL",
                ...
                "required": False,
                "secret": False,
                "description": "Использовать мобильную версию поиска",
            },
        ],
    },
    {
        ...
        "settings_schema": [
            {
                ...
                "required": True,
                "secret": False,
                "description": "Folder ID из Yandex Cloud, в котором создан сервисный аккаунт",
            },
            {
                "key": "api_key",
                "label": "API-ключ",
