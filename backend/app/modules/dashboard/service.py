...
async def get_dashboard_data(
    ...
    timed = [r for r in completed if getattr(r, "started_at", None) and getattr(r, "finished_at", None)]
    if timed:
        total_sec = sum((r.finished_at - r.started_at).total_seconds() for r in timed)
