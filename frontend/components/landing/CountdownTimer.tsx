...
// Обратный отсчёт до запуска SpinLid (цель: 2026-08-29 00:00 МСК,
// = 2026-07-29 + ~30 дней). Висит внутри hero на главной — четыре
...
const LAUNCH_AT = new Date('2026-08-29T00:00:00+03:00').getTime();
