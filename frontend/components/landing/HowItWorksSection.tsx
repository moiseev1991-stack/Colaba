...
const STEPS = [
  ...
  {
    num: '04',
    title: 'Отправьте письмо сами',
    desc: 'Скопируйте готовый текст в свою почту или CRM либо выгрузите список в Excel. Письмо уходит от вашей компании — так ему больше доверия.',
  },
];
  ...
  return (
    <section id="how" className="landing-section l-how">
      <div className="container">
        ...
        >
          На выходе: карточки с диагнозом → черновики писем → выгрузка в Excel или ваша почта
        </p>
      </div>
    </section>
  );
