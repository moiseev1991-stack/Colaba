...
const MODULES = [
  {
    ...
    bullets: ['Москва, Санкт-Петербург и другие города', 'Телефоны, сайты и мессенджеры из карточек', 'Фильтры по рейтингу, негативу, наличию сайта'],
  },
  {
    svg: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    ...
    bullets: ['Шаблоны под нишу и тон письма', 'Регенерация и ручная правка', 'Черновики сразу на весь список'],
  },
  {
    svg: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    ...
    bullets: ['Рассылка по выбранным компаниям', 'Доставлено / Открыто / Кликнул / Ошибка', 'Все ответы — в одном ящике'],
  },
  {
    svg: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
