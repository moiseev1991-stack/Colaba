...
export function LoadingProcessPanel({
  ...
  return (
    <div className="w-full max-w-[900px] mx-auto rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-md overflow-hidden">
      <div className="px-4 py-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-gray-200 dark:border-gray-600">
        ...
        {done && (
          <span className="inline-flex items-center rounded-md bg-green-100 dark:bg-green-900/30 px-2.5 py-1 text-xs font-medium text-green-800 dark:text-green-200 shrink-0">
            Готово
          </span>
        )}
      </div>
              ...
              <div className="mt-1.5 h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden">
                <div
                  className={cn(
                    ...
                    done ? 'bg-green-600 dark:bg-green-500' : 'bg-red-600 dark:bg-red-500'
                  )}
