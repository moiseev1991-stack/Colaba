...
// solutions[4]). Общие блоки («Как проходит разбор», «Кто я», форма, FAQ,
        ...
        <section className="l-hero" id="top">
          ...
          <div className="l-hero__inner">
            <div>
              ...
              <p className="l-hero__sub reveal">{config.hero.sub}</p>
              ...
              <div className="l-hero__actions reveal">
                ...
                <a className="l-btn l-btn--ghost" href={tgUrl} rel="noopener" target="_blank">
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none">
