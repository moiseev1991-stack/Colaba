...
export function ProcessingHero({
  ...
  return (
    <div
      className={cn(
        'rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-sm overflow-hidden w-full'
      )}
    >
          ...
          {determinate ? (
            <div className="w-full space-y-1.5 mb-3">
              ...
              <div className="h-2 w-full rounded-full bg-gray-200 dark:bg-gray-700 overflow-hidden">
                <div
                  className="h-full rounded-full bg-red-600 dark:bg-red-500 transition-all duration-150 ease-linear"
