        ...
        <div className="flex items-center gap-2">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 shrink-0 rounded-full border transition-colors focus:outline-none focus:ring-2 focus:ring-saas-primary focus:ring-offset-2 focus:ring-offset-[#0f172a] ${
                autoRefresh ? 'border-saas-primary bg-saas-primary' : 'border-gray-600 bg-gray-700'
              }`}
            >
              <span
