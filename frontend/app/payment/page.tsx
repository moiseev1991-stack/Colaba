  ...
  return (
    <div className="max-w-[500px] mx-auto px-6 py-8">
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
        ...
        <button
          onClick={handlePay}
          className="w-full bg-black hover:bg-gray-900 text-white rounded-lg p-4 mb-4 flex items-center justify-between transition-colors"
        >
        ...
        <button
          onClick={handlePay}
          className="w-full bg-[#6B46C1] hover:bg-[#5B21B6] text-white rounded-lg p-4 mb-6 flex items-center justify-between border-2 border-red-500 transition-colors"
        >
