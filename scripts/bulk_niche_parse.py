...
# 2026-07-13: расширенная матрица. 5 приоритетных ниш × 10 городов = 50 запросов.
# Приоритет — где чек 5к+, конкуренция за трафик, часто нет CRM = боль реальна
# и покупательская способность на автоматизацию есть. Города — Москва + СПб +
# 4 подмосковных спутника + 4 региональных млн-ника.
